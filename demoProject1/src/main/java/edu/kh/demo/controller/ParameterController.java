...
public class ParameterController {
	...
	public String paramMain() {
		...
		// 접미사 : .html
		// 접두사 + return 값 + 접미사
		// -> src/main/resources/template/param/param-main.html
	 ...
	 * 
	 * [속성 추가 작성법]
	 * @RequestParam(value="name", required="false", defalutValue="1")
	 * 
	 * value : 전달받은 input태그의 name 속성값 (파라미터 key)
	 * 
	...
	public String paramTest3(
		...
		// {color=red, fruit=Apple, productName=테스트박스, expirationDate=2024-10-24}
