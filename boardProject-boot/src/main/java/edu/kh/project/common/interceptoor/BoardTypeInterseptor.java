package edu.kh.project.common.interceptoor;
 ...
 * 
 * - postHandle(후처리) : Controller -> Dispatcher Servlet
 * 
 * - afterCompletio (뷰 완성(forward 코드 해석) 후) : View Resolver -> Dispatcher Servlet 사이 수행
 * 
 * */


public class BoardTypeInterseptor implements HandlerInterceptor{
