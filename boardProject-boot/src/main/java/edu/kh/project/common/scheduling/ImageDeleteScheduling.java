...
public class ImageDeleteScheduling {
	...
	public void scheduling() {
		...
		List<String> dbImageList = service.selectDbImageLisst();
 ...
 *
 * 설정 방법 1) XXXAPPlication.java 파일에 @EnableScheduling 어노테이션 추가 2) 스케쥴링 동작을 위한
 * 클래스 작성
 *
 *
 * @Scheduled 속성 - fixedDelay : 이전 작업이 끝난 시점으로 부터 고정된 시간(ms)을 설정.
 * 
