...
public class MyPageController {
	...
	public String info(
		...
		// 현재 로그인한 회원의 주소를 꺼내옴
		// 현재 로그인한 회원 정보 -> Session 에 등록한 상태 (loginMember)
		// log.debug("loginMember : " + loginMember);
		// memberAddress=04533^^^서울 중구 을지로1가 192-11^^^3층, KH정보교육원
		...
		if(memberAddress != null) {
			...
			String[] arr = memberAddress.split("\\Q^^^\\E");
